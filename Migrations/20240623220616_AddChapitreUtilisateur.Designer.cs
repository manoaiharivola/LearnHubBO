...
namespace LearnHubBO.Migrations
{
    ...
    [Migration("20240623220616_AddChapitreUtilisateur")]
    partial class AddChapitreUtilisateur
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnHubBO.Models.ChapitreUtilisateur", b =>
                {
                    b.Property<int>("IdChapitreUtilisateur")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdChapitreUtilisateur"));

                    b.Property<DateTime>("DateCreationChapitreUtilisateur")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("IdChapitreUtilisateur");

                    b.HasIndex("IdChapitre");

                    b.HasIndex("IdUtilisateur");

                    b.ToTable("ChapitreUtilisateur");
                });
            ...
            modelBuilder.Entity("LearnHubBO.Models.ChapitreUtilisateur", b =>
                {
                    b.HasOne("LearnHubBO.Models.Chapitre", "Chapitre")
                        .WithMany()
                        .HasForeignKey("IdChapitre")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
